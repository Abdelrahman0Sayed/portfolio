...
export const writeupsData: Record<string, WriteupContent> = {
  'zinad-26-rev': {
    ...
    coverImage: assetPath('/writeup-cover/zinad-26-reverse.png'),
  ...
  'react2shell': {
    ...
    coverImage: assetPath('/writeup-cover/react2shell.png'),
  ...
  'htb-facts': {
    ...
    coverImage: assetPath('/writeup-cover/HTB_Facts.png'),
  ...
  'cve-2025-24071': {
    ...
    coverImage: assetPath('/writeup-cover/CVE-2025-24071.png'),
  ...
  'android-hacking-intro': {
    ...
    coverImage: assetPath('/writeup-cover/AndroidHacking.png'),
    tags: ['Mobile', 'OWASP'],
    content: null,
  },
  'json-rce': {
    ...
    coverImage: assetPath('/placeholder-logo.png'),
  ...
  'privesc-to-application-admin': {
    ...
    coverImage: assetPath('/writeup-cover/privsec-to-application-admin.png'),
